<%-- Created by IntelliJ IDEA. User: 用尽心意 Date: 2022/11/10 Time: 12:32 To change this template use File | Settings |
    File Templates. --%>
    ...
    <div class="aw-top-menu-wrap">
        <div class="container">
            ...
            <div class="aw-user-nav">
                <a class="login btn btn-small btn-primary" href="showLogin.do">登录</a>
                ...
                <div class="col-sm-12">
                    <ul class="list">
                        <c:forEach items="${requestScope.zones}" var="zone">
                            <c:if test="${zone.id == 0}">
                                <li class="${zone.id} active">
                                    <a href="index.do">${zone.name}</a>
                                </li>
                            </c:if>
                            <c:if test="${!(zone.id == 0)}">
                                <li class="${zone.id}">
                                    <a href="${zone.zone}.do?id=${zone.id}" onclick="">${zone.name}</a>
                                </li>
                            </c:if>
                        </c:forEach>
                    </ul>
            ...
            <div class="row" style="background: white">
                <div class="aw-content-warp clearfix">
                    ...
                    <ul class="nav nav-tabs aw-nav-tabs active hidden-xs">
                        <li>
                            <a href="hotTopics.do?id=0">
                                <span>热门</span>
                            </a>
                        </li>
                        <li>
                            <a href="recommend.do?id=0">
                                <span>推荐</span>
                            </a>
                        </li>
                        <li class="active">
                            <a href="index.do?id=0">
                                <span>最新</span>
                            </a>
                        </li>
                        <h2>
                                ...
                                <c:forEach items="${requestScope.messages}" var="message">
                                    <div class="aw-item active" data-topic-id>
                                        ...
                                        <div class="aw-question-content">
                                            <h4>
                                                <a href="${message.skip}">${message.content}</a>
                                            </h4>
                                            ...
                                            <p>
                                                ...
                                                <span>发起了问题•${message.attention}人关注•${message.reply}个回复•${message.pageview}次浏览量•${message.date}</span>
                                            </p>
                                        </div>
                                    </div>
                                </c:forEach>
